class TodoContainer{
    ...
    render(){
        this.wrapper = createEl("div", "wrap", document.body)
        this.main = createEl("div", "main", this.wrapper)
        this.newtodo = createEl("button", "newTodoBtn", this.wrapper)
        this.newtodo.innerText = "+"
        this.newtodo.addEventListener("click", (e) => {
            new TodoContainer()
        }, true)
        this.deltodo = createEl("button", "delTodoBtn", this.wrapper)
        this.deltodo.innerText = "x"
        this.deltodo.addEventListener("click", (e) => {
           this.wrapper.remove()
        })
        this.title = createEl("div", "title", this.main)
        this.title.innerText = "title"
        const ulC = new UlComponent()
        this.main.appendChild(ulC.render(this.lis))
        this.main.appendChild(new InputComponent().render())
        console.log(new UlComponent())
        this.main.appendChild(new FooterComponent().render())
